...
possible_events = {
    ...
    ("click left of",): MouseButton.SPATIAL_LEFT | MouseButton.LEFT,
    ("click right of",): MouseButton.SPATIAL_RIGHT | MouseButton.LEFT,
    ("click above of", "click on top of"): MouseButton.SPATIAL_ABOVE | MouseButton.LEFT,
    ("click below of", "click under"): MouseButton.SPATIAL_BELOW | MouseButton.LEFT,
